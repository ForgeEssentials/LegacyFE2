...
public interface ITypeInfo<T> {
	/**
	 * If this class should be saved inLine with a class that has this as a
	 * field. If true, the UniqueKey will be saved, and will reference the class
	 * by its unique key elsewhere.
	 * 
	 * @return
	 */
	...
	/**
	 * Should return the type of the field. NULL if the field does not exist, or
	 * is undefined in this type. Must be case insensative!
	 * 
	 * @param field
	 *            Name of the field.
	...
	/**
	 * This should return a fully populated TypeData instance. This instance may
	 * be a specially created implementation, or be obtained via the
	 * DataStorageManager. DON'T FORGET THE UNIQUE KEY!
	 */
	 ...
	 * 
	 * @param data
	 *            If this class has a TypeDataOverride, you can cast it.
