...
public class TypeInfoNBTCompound extends TypeMultiValInfo {
	...
	public Object reconstruct(TypeData[] data, IReconstructData rawType) {
		...
		for (TypeData dat : data) {
			...
			case 1:
				nbt.setByte(name,
						Byte.parseByte(dat.getFieldValue(PRIMITIVE).toString()));
				break;
			case 2:
				nbt.setShort(name, Short.parseShort(dat
						.getFieldValue(PRIMITIVE).toString()));
				break;
			case 3:
				nbt.setInteger(name, Integer.parseInt(dat.getFieldValue(
						PRIMITIVE).toString()));
				break;
			case 4:
				nbt.setLong(name,
						Long.parseLong(dat.getFieldValue(PRIMITIVE).toString()));
				break;
			case 5:
				nbt.setFloat(name, Float.parseFloat(dat
						.getFieldValue(PRIMITIVE).toString()));
				break;
			case 6:
				nbt.setDouble(name, Double.parseDouble(dat.getFieldValue(
						PRIMITIVE).toString()));
				break;
			case 7:
			...
			case 8:
				...
				break;
			case 10:
				nbt.setCompoundTag(name,
						(NBTTagCompound) dat.getFieldValue(COMPOUND));
				break;
			case 11:
