...
public class TypeInfoSerialize<T> implements ITypeInfo<T>
{
	...
	public TypeData getTypeDataFromObject(T obj)
	{
		...
		{
			OutputHandler.felog.log(Level.SEVERE, "Reflection error trying to get UniqueLoadingKey from " + obj.getClass() + ". FE will continue without saving this.", e);
		}
		...
		for (int i = 0; i < keys.length; ++i)
		{
			...
			catch (NoSuchFieldException e)
			{
				...
				if (currentClass == null)
				{
					...
					OutputHandler.felog.log(Level.SEVERE, "Reflection error trying to save " + obj.getClass() + ". FE will continue without saving this.", e);
				}
				--i;
			}
			catch (Exception e)
