...
public enum EnumDBType {
	H2_FILE(false, "org.h2.Driver",
			"jdbc:h2:file:%s;IGNORECASE=TRUE;FILE_LOCK=NO;MODE=MYSQL"), // file
	...
	public void loadClass() {
		try {
			...
			OutputHandler.felog.severe("Could not load the " + this
					+ " JDBC Driver! Does it exist in the lib directory?");
	 ...
	 */
	public String getConnectionString(Object... data)
