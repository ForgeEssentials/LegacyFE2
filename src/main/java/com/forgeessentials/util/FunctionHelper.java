...
import com.forgeessentials.util.areas.WarpPoint;
...
public class FunctionHelper {
	...
	public static String format(String format)
	{
		...
		format = replaceAllIgnoreCase(format, "%purple", EnumChatFormatting.LIGHT_PURPLE.toString());
		...
		format = replaceAllIgnoreCase(format, "%indigo", EnumChatFormatting.DARK_PURPLE.toString());
		...
		format = replaceAllIgnoreCase(format, "%pink", EnumChatFormatting.RED.toString());
