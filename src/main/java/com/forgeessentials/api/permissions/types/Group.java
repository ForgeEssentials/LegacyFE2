package com.forgeessentials.api.permissions.types;
...
public class Group implements Comparable {
	...
	public boolean equals(Object obj) {
		...
		return name.equalsIgnoreCase(g.name) && p && pre && suff
	...
	public String toString() {
		return name + "[" + parent + ", " + prefix + ", " + suffix + ", "
				+ zoneName + ", " + priority + "]";
	}
