...
public enum RegGroup {
	 ...
	 */
	ZONE_ADMINS("ZoneAdmins", EnumChatFormatting.RED + "[ZoneAdmin]", " ",
			null, 0),
	...
	private RegGroup(String name, String parent, String prefix, String suffix,
			int priority) {
		this.name = name;
		group = new Group(name, parent, prefix, suffix, APIRegistry.zones
				.getGLOBAL().getZoneName(), priority);
	}
